...
public final class ActivityPermissionBinding implements ViewBinding {
  ...
  @NonNull
  public final ConstraintLayout PermissionActivity;
  ...
  private ActivityPermissionBinding(@NonNull ConstraintLayout rootView,
      @NonNull ConstraintLayout PermissionActivity, @NonNull Button PermissionBtn,
  ...
  public static ActivityPermissionBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      ConstraintLayout PermissionActivity = (ConstraintLayout) rootView;

      id = R.id.PermissionBtn;
      ...
      return new ActivityPermissionBinding((ConstraintLayout) rootView, PermissionActivity,
          PermissionBtn, textView);
    }
